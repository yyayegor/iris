...
class Test(BaseTest):
    ...
    def run(self):
        ...
        assert_true(self, master_password_box_is_checked,
                    'Master password is set in Normal Browsing tab.')
        ...
        hover(preferences_privacy_find_field_pattern)
        paste('Use a master password')
        ...
        click(master_password_box_is_checked_pattern, 0.2)
        ...
        unchecked_use_master_password_checkbox_exists = exists(master_password_box_is_unchecked_pattern, 20)
        assert_true(self, unchecked_use_master_password_checkbox_exists,
                    'Master Password checkbox is unchecked in Private Browsing tab.')
        close_window()
        ...
        unchecked_use_master_password_checkbox_exists = exists(master_password_box_is_unchecked_pattern, 20)
        assert_true(self, unchecked_use_master_password_checkbox_exists,
                    'Master Password checkbox is unchecked in Normal Browsing tab.')
