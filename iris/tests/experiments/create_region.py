...
class Test(BaseTest):
    ...
    def run(self):
        ...
        print('Text in URL bar: %s' % r.text(image_processing=True))
        ...
        # assert_true(self, r1.exists('This is a cat'), '"This is a cat" found')
        ...
        # assert_true(self, r2.exists('This is a dog'), '"This is a dog" found')
